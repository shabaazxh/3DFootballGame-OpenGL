...
void GameInterface::SkyBox()
{
    ...
    glTranslatef(0, 110.0f, 0);
    glScalef(500, 450, -450); //450, 450
...
void GameInterface::GameInstructions()
{
    ...
    std::cout << "Press space to shoot the ball " << std::endl;
...
void keyboard(unsigned char key, int x, int y)
{
    ...
    switch (key)
    {
    case ' ': //Allow player to move ball : update attemps : check attemps : check reset for attemps
